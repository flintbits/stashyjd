...
import { subscribeApiState } from '../../lib/invokeSafe';
...
export default function CreateApplication({ rightPanelWidth = 320 }) {
  ...
  const handleCreateApplication = async () => {
    try {
      ...
      addToast({
        message: `Unable to create application ${err.message}`,
        type: 'error',
      });
    }
  };
    ...
    <PageShell scrollable>
      <PageHeader
        ...
        subtitle=" Add job details manually or paste a job description to enrich your
          application."
      >
        <Button text="Create Application" onClick={handleCreateApplication} loading={loading} />
        <Button text="Fill All the fields" onClick={handleFillFields} loading={loading} />
      </PageHeader>
