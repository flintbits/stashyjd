...
export default function DocumentsPickerBlock({ values, onChange }) {
  ...
  return (
    <div
      className={`${styles["custom-block"]} ${styles["docs-matching-block"]}`}
    >
          ...
          <div className={styles["matching-analysis"]}>
            ...
            <div className={styles["matching-stats"]}>
              <div className={styles.stat}>
                <span className={`${styles.dot} ${styles.success}`}></span>{" "}
                Matched Keywords (18)
              </div>
              <div className={styles.stat}>
                <span className={`${styles.dot} ${styles.error}`}></span>{" "}
                Missing Keywords (4)
              </div>
            </div>
